...
const hero_data: DataType = {
  ...
  des: `We specialize in website design and development, building user-friendly, responsive, and high-performing websites that align with your business goals. Our digital marketing strategies, including SEO, content marketing, and social media growth, are designed to drive measurable results and boost visibility. Through targeted online advertising campaigns on platforms like Google, Facebook, and Instagram, we help maximize your ROI, while our brand growth solutions ensure your business stands out with compelling visuals, strong branding, and conversion-focused strategies.`,
  social_links: [
    {
      id: 1,
      img: facebook,
