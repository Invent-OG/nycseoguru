...
const portfolio_data: DataType[] = [
  {
    ...
    subtitle: "UI/UX & SEO Optimization",
  },
  {
    img: portfolio_img_2,
  ...
  },
  {
    ...
    subtitle: "Google Maps Marketing",
  },
  {
    img: portfolio_img_2,
    title: "Content Strategy Portal",
    subtitle: "Content Writing & SEO",
  },
  {
    img: portfolio_img_3,
    title: "Startup Product Launch",
    subtitle: "Google Ads & Online Marketing",
  },
];
          ...
          <div className="cs_section_heading cs_style_1 cs_type_2">
            <div className="cs_section_heading_text">
              ...
              <h2 className="cs_section_title anim_heading_title">
                Our Recently Completed Case Studies
              </h2>
            </div>
          </div>
