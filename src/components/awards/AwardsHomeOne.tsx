...
const award_data: DataType[] = [
  {
    ...
    des: `Recognized for delivering outstanding digital solutions and achieving excellence in client satisfaction worldwide.`,
  },
  {
    id: 2,
    ...
    des: `Awarded for innovation and quality in building scalable, user-friendly websites that drive measurable results.`,
  },
  {
    id: 3,
    ...
    des: `Honored for crafting unique brand experiences and creative strategies that engage audiences effectively.`,
  },
];
