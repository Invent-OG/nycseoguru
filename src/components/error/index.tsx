            ...
            <div className="cs_center">
              <div className="row col-md-8 col-12">
                ...
                <p className="cs_font_16 text-center cs_m0">
                  A 404 error is usually caused by issues on the client’s side,
                  which makes it one of the easier problems for website owners
                  to resolve. In this article, we’ll cover the common reasons
                  behind error 404 and walk you through four practical solutions
                  to fix it.
                </p>
