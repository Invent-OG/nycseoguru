...
const feature_data: DataType = {
  ...
  des: `At our digital agency, we focus on delivering impactful solutions that drive growth. From innovative website development to result-driven marketing strategies, we provide the tools to help your business thrive in today’s competitive market.`,
  boxtitle: `Creative Approach`,
  box_des_1: `Innovative & Scalable Solutions`,
  box_des_2: `Cutting-edge strategies tailored for success`,
  features: [
    {
      id: 1,
      title: `Optimized Performance`,
      des_1: `Fast, secure, and reliable code`,
      des_2: `Ensuring seamless digital experiences`,
    },
    {
      id: 2,
      title: `User-Centered Design`,
      des_1: `Built with your audience in mind`,
      des_2: `Delivering intuitive and engaging interfaces`,
    },
  ],

  // for home five
  subtitle_2: `Why Partner With Us`,
  title_2: `Driving Growth Through Strategy, Innovation & Technology`,
};
