...
const footer_data: DataType = {
  email: `nycseoguru@email.com`,
  phone: `(406) 555-0120`,
  location: `46 JOHN ST TORONTO ON M5V 3W2`,
  footer_info: `Transforming Ideas into Digital Success. Our agency crafts innovative websites and tailored online solutions that help businesses like yours grow, engage audiences, and achieve measurable results.`,
  links: [
    { title: `HOME`, link: "/" },
